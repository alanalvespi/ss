  ...
  def create
    ...
    respond_to do |format|
      if @strategies_market.save
        format.html { redirect_to @strategies_market, notice: 'Strategies market was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @strategies_market.update_attributes(params[:strategies_market])
        format.html { redirect_to @strategies_market, notice: 'Strategies market was successfully updated.' }
