...
class TodolistsControllerTest < ActionController::TestCase
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post :create, todolist: { description: @todolist.description, id: @todolist.id, reason: @todolist.reason, state: @todolist.state, tablename: @todolist.tablename }
    end
  ...
  test "should update todolist" do
    put :update, id: @todolist, todolist: { description: @todolist.description, id: @todolist.id, reason: @todolist.reason, state: @todolist.state, tablename: @todolist.tablename }
    assert_redirected_to todolist_path(assigns(:todolist))
  end
